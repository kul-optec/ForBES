...
forbes.tests.test_inequalities1;
fprintf('OK (%5.2f s)\n', toc());
...
fprintf('%36s', 'SolveLasso_small'); tic();
forbes.tests.test_SolveLasso_small;
fprintf(' OK (%5.2f s)\n', toc());

fprintf('%36s', 'SolveLasso_random'); tic();
forbes.tests.test_SolveLasso_random;
fprintf(' OK (%5.2f s)\n', toc());

fprintf('%36s', 'SolveSparseLogReg_small'); tic();
